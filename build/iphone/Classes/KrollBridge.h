...
@interface SiWriterProObject : KrollCoverageObject {
#else
@interface SiWriterProObject : KrollObject {
#endif
@private
...
extern NSString * SiWriterPro$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	SiWriterProObject *_siwriterpro;
    KrollObject* console;
	BOOL shutdown;
