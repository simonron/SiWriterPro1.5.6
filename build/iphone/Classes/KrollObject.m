...
//@interface SiWriterProObject : NSObject
//@end

@interface SiWriterProObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SiWriterProObject class]])
		{
			for (NSString *key in [[(SiWriterProObject*)o modules] allKeys])
			{
